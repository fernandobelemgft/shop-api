...
public class GeolocationService {
	...
	/**
	 * Returns the {@link PlaceLocation} object which contains 
	 * the longitude and latitude data required in Shop object
	 * 
	 * @param postalCode
	 * @param number
	 * @return {@link PlaceLocation}
	 * @throws LocationNotFoundException when the given information 
	 * does not retrieve a valid PlaceLocation object
	 */
	public PlaceLocation getPlaceLocation(String postalCode, String number) throws LocationNotFoundException {
		...
		if(response.getResult().length == 0){
			throw new LocationNotFoundException("Location not found - Postal code: " + postalCode + ", number: " + number);
		}
