...
public class DistanceMatrixServiceTest {
	...
	public void insertDummyData() throws LocationNotFoundException{
		...
		shopService.saveShop(new Shop("Birmingham Shop", new ShopAddress("1", "B1 1BA")));
	...
	public void getNearestTest() throws LocationNotFoundException{
		...
		//Client geolocation from: Ryecote Lane, Milton Common OX9 2PU, United Kingdom
		Shop shop = distanceMatrix.getNearest(shopList, "51.7279805", "-1.0259525");
		...
		Shop shop2 = distanceMatrix.getNearest(shopList, "52.911486", "-1.5124852");
	...
	public void getNearestShopInvalidLocation() throws LocationNotFoundException{
		distanceMatrix.getNearest(shopList, "", "");
	}
	
	@Test(expected=LocationNotFoundException.class)
	public void getNearestShopInvalidLocationData() throws LocationNotFoundException{
